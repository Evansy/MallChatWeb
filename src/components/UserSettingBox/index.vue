...
<template>
  ...
  >
    <div class="setting-box">
        ...
        <div class="name-edit-wrapper" v-show="editName.isEdit === false">
          ...
          >
            <el-button
              ...
              size="small"
              :class="userInfo?.modifyNameChance && userInfo.modifyNameChance > 0 ? 'pointer' : 'not-allow is-disabled'"
              :icon="EditPen"
              circle
              @click="onEditName"
            />
      ...
      <el-alert class="setting-tips" title="Tips: MallChat名称不允许重复，快来抢占" type="warning" :closable="false" />
